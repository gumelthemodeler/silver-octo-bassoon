...
EnemyData.WorldBosses = {
	...
	["Lara Tybur"] = {
		...
		Health = 450000, GateType = "Hardening", GateHP = 50000, Strength = 350, Defense = 250, Speed = 120, Resolve = 800, TitanStats = {Power="S", Speed="A", Hardening="S", Endurance="B", Precision="S", Potential="A"},
...
EnemyData.Parts = {
	...
	[3] = {
		...
		Templates = {
			...
			["Female Titan (Forest)"] = { Name = "Female Titan (Pursuit)", Health = 1500, GateType = "Hardening", GateHP = 500, Strength = 45, Defense = 30, Speed = 50, Resolve = 40, TitanStats = {Power="A", Speed="A", Hardening="A", Endurance="B", Precision="B", Potential="B"}, Skills = {"Hardened Punch", "Leg Sweep", "Brutal Swipe"}, Drops = { Dews = 200, XP = 500, ItemChance = {["Standard Titan Serum"]=2} } },
			["Part3Boss"] = { IsBoss = true, Name = "Female Titan (Annie)", Health = 3000, GateType = "Hardening", GateHP = 1500, Strength = 55, Defense = 45, Speed = 60, Resolve = 50, TitanStats = {Power="A", Speed="A", Hardening="A", Endurance="B", Precision="B", Potential="B"}, Skills = {"Hardened Punch", "Nape Guard", "Leg Sweep"}, Drops = { Dews = 800, XP = 2000, ItemChance = { ["Ultrahard Steel Blades"] = 20, ["Standard Titan Serum"]=10 } } }
		},
		Missions = {
			[1] = { Name = "Clash of the Titans", Waves = { 
				...
				{ Template = "Field Titan", Flavor = "The right flank is crumbling!" }, 
				{ Template = "Tree Glider Abnormal", Flavor = "An abnormal is ignoring the flares! Intercept it!" }, 
				{ Template = "Field Titan", Flavor = "Hold the line! Don't let them reach the wagon!" }, 
				{ Template = "Tree Glider Abnormal", Flavor = "Another abnormal is charging through the forest!" }, 
	...
	[4] = {
		...
		Missions = {
			[1] = { Name = "The Uprising", Waves = { 
				...
				{ Template = "Interior MP", Flavor = "More MPs are moving in to suppress you!" }, 
				{ Template = "Anti-Personnel MP", Flavor = "You've entered the Crystal Caverns. They have guns instead of blades! Take cover!" }, 
				{ Template = "Anti-Personnel MP", Flavor = "Watch out, they are aiming for your ODM gear!" }, 
				{ Template = "Interior MP", Flavor = "They are trying to surround you!" }, 
	...
	[5] = {
		...
		Missions = {
			[1] = { Name = "Marleyan Assault", Waves = { 
				{ Template = "Marleyan Guard", Flavor = "You've infiltrated Liberio. Marleyan soldiers have spotted you!" }, 
				{ Template = "Marleyan Guard", Flavor = "Reinforcements are arriving!" }, 
				{ Template = "Marleyan Sniper", Flavor = "Taking fire from the rooftops!" }, 
				{ Template = "Marleyan Guard", Flavor = "They're trying to pin you down in the alleyways." }, 
				{ Template = "Marleyan Sniper", Flavor = "Another sniper on the bell tower!" }, 
				{ Template = "Part5Boss", Flavor = "<font color='#FF5555'>WARNING: An elite Warrior Candidate has intercepted you!</font>" } 
			} }
		}
	},
	...
	[6] = {
		...
		Missions = {
			[1] = { Name = "Return to Shiganshina", Waves = { 
				...
				{ Template = "Zeke's Controlled Titan", Flavor = "They are moving in formation. Cut them down!" }, 
				{ Template = "Beast Titan Pitcher", Flavor = "A barrage of crushed boulders obliterates the front lines!" }, 
				{ Template = "Zeke's Controlled Titan", Flavor = "The horde is closing in on the horses!" }, 
				{ Template = "Beast Titan Pitcher", Flavor = "More rocks are raining from the sky! Take cover!" }, 
	...
	[7] = {
		...
		Missions = {
			[1] = { Name = "War for Paradis", Waves = { 
				...
				{ Template = "Marleyan Paratrooper", Flavor = "More soldiers are landing in the district!" }, 
				{ Template = "Anti-Titan Artillery", Flavor = "They've mounted cannons on the walls! Take them out!" }, 
				{ Template = "Marleyan Paratrooper", Flavor = "They are pushing toward the command center!" }, 
				{ Template = "Anti-Titan Artillery", Flavor = "Another artillery battery is locking onto Eren!" }, 
	...
	[8] = {
		...
		Missions = {
			[1] = { Name = "The Rumbling", Waves = { 
				...
				{ Template = "Wall Titan", Flavor = "The heat is unbearable. Keep moving forward." }, 
				{ Template = "Ancient Shifter", Flavor = "Ymir is summoning Titans from past generations on the Founding Titan's back!" }, 
				{ Template = "Wall Titan", Flavor = "You must break through the wall of steam!" }, 
				{ Template = "Ancient Shifter", Flavor = "Another ancient shifter blocks your path!" }, 
				{ Template = "Ancient Shifter", Flavor = "They are swarming you! Don't give up!" }, 
