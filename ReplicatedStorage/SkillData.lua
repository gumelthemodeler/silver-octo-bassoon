...
SkillData.Skills = {
	...
	["Spinning Slash"] = { Requirement = "ODM", Range = "Close", Type = "Style", Mult = 1.2, Hits = 3, GasCost = 20, Order = 7, ComboReq = "Basic Slash", ComboMult = 1.3, SFX = "SpinSlash", VFX = "SlashMark", Description = "Burn gas to rapidly spin and slash the target 3 times." },
	...
	["Dual Slash"] = { Requirement = "Ultrahard Steel Blades", Range = "Close", Type = "Style", Mult = 1.4, GasCost = 10, Cooldown = 0, Order = 9, SFX = "DualSlash", VFX = "SlashMark", Description = "A rapid double strike using both blades." },
	...
	["Vortex Slash"] = { Requirement = "Ultrahard Steel Blades", Range = "Close", Type = "Style", Mult = 2.8, Hits = 5, Effect = "Bleed", Duration = 2, GasCost = 35, Cooldown = 5, Order = 11, ComboReq = "Momentum Strike", ComboMult = 1.6, SFX = "SpinSlash", VFX = "ExplosionMark", Description = "A devastating whirlwind of blades that shreds the target." },
	...
	["Reckless Barrage"] = { Requirement = "Thunder Spears", Range = "Any", Type = "Style", Mult = 0.8, Hits = 4, GasCost = 30, Cooldown = 6, Order = 11, ComboReq = "Spear Volley", ComboMult = 1.4, SFX = "BigExplosion", VFX = "ExplosionMark", Description = "Unleash a barrage of spears at once." },
	...
	["Buckshot Spread"] = { Requirement = "Anti-Personnel", Range = "Any", Type = "Style", Mult = 0.8, Hits = 3, GasCost = 10, Cooldown = 0, Order = 9, SFX = "Gun", VFX = "ExplosionMark", Description = "Fires a wide spread of buckshot from your ODM guns." },
	...
	-- [[ ACKERMAN CHAIN ]]
	["Ackerman Flurry"] = { Requirement = "Ackerman", Range = "Close", Type = "Style", Mult = 0.6, Hits = 5, GasCost = 35, Cooldown = 4, Order = 15, SFX = "DualSlash", VFX = "SlashMark", Description = "A blindingly fast sequence of lethal strikes." },
	...
	["God Speed"] = { Requirement = "Awakened Ackerman", Range = "Close", Type = "Style", Mult = 1.5, Hits = 8, GasCost = 60, Effect = "Stun", Duration = 2, Cooldown = 6, Order = 17, ComboReq = "Swift Execution", ComboMult = 1.8, SFX = "SpinSlash", VFX = "ClawMark", Description = "Move faster than the eye can see, shredding the target completely." },
	...
	["Armored Tackle"] = { Requirement = "Armored Titan", Range = "Any", Effect = "CloseGap", Type = "Titan", Mult = 4.0, Duration = 1, EnergyCost = 40, Cooldown = 5, Telegraphed = true, Order = 13, SFX = "HeavyPunch", VFX = "ExplosionMark", Description = "A devastating, unstoppable charge that closes the gap and stuns." },
	...
	["Colossal Steam"] = { Requirement = "Colossal Titan", Range = "Any", Type = "Titan", Mult = 2.5, Hits = 2, Effect = "Burn", Duration = 3, EnergyCost = 50, Cooldown = 7, Telegraphed = true, Order = 13, SFX = "Steam", VFX = "ExplosionMark", Description = "Emit waves of scorching steam, burning anyone nearby." },
	["Coordinate Command"] = { Requirement = "Founding Titan", Range = "Any", Type = "Titan", Mult = 6.0, Effect = "Stun", Duration = 3, EnergyCost = 80, Cooldown = 8, Telegraphed = true, Order = 13, SFX = "Roar", VFX = "ClawMark", Description = "Command pure titans to swarm and crush the enemy completely." },
	...
	["Crushed Boulders"] = { Requirement = "Enemy", Range = "Any", Type = "Titan", Mult = 1.8, Effect = "GasDrain", Duration = 0, Cooldown = 1, Telegraphed = true, SFX = "Explosion", VFX = "ExplosionMark", Description = "Throws a massive spread of crushed rocks." },
	["Anti-Titan Round"] = { Requirement = "Enemy", Range = "Any", Type = "Basic", Mult = 2.5, Effect = "Bleed", Duration = 3, Cooldown = 4, Telegraphed = true, SFX = "Sniper", VFX = "ExplosionMark", Description = "Fires a massive armor-piercing shell." },
