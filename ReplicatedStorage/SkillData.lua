...
SkillData.Skills = {
	...
	["Colossal Steam"] = { Requirement = "Colossal Titan", Range = "Any", Type = "Titan", Mult = 1.5, Hits = 2, Effect = "Burn", Duration = 3, EnergyCost = 50, Cooldown = 7, Telegraphed = true, Order = 13, SFX = "Steam", VFX = "ExplosionMark", Description = "Emit waves of scorching steam, burning anyone nearby." },
