...
SkillData.Skills = {
	...
	["Nape Strike"] = { Requirement = "ODM", Type = "Style", Mult = 2.5, Effect = "Bleed", Duration = 3, GasCost = 25, Cooldown = 4, Order = 7, ComboReq = "Spinning Slash", ComboMult = 1.5, SFX = "HeavySlash", VFX = "SlashMark", Description = "A precise, lethal strike to the vital point. Causes Bleed." },
	...
	["Momentum Strike"] = { Requirement = "Ultrahard Steel Blades", Type = "Style", Mult = 1.8, GasCost = 15, Cooldown = 2, Order = 9, ComboReq = "Dual Slash", ComboMult = 1.4, SFX = "HeavySlash", VFX = "SlashMark", Description = "Use the momentum of your previous slash for a heavy blow." },
	["Vortex Slash"] = { Requirement = "Ultrahard Steel Blades", Type = "Style", Mult = 2.8, Hits = 5, Effect = "Bleed", Duration = 2, GasCost = 35, Cooldown = 5, Order = 10, ComboReq = "Momentum Strike", ComboMult = 1.6, SFX = "SpinSlash", VFX = "ExplosionMark", Description = "A devastating whirlwind of blades that shreds the target." },
	["Blade Toss"] = { Requirement = "Ultrahard Steel Blades", Type = "Style", Mult = 1.8, Effect = "Bleed", Duration = 2, GasCost = 15, Cooldown = 3, Order = 11, SFX = "Dash", VFX = "SlashMark", Description = "Throw your blades like projectiles into the target's eyes." },
	...
	["Reckless Barrage"] = { Requirement = "Thunder Spears", Type = "Style", Mult = 0.8, Hits = 4, GasCost = 30, Cooldown = 6, Order = 10, ComboReq = "Spear Volley", ComboMult = 1.4, SFX = "BigExplosion", VFX = "ExplosionMark", Description = "Unleash a barrage of spears at once." },
	["Detonator Dive"] = { Requirement = "Thunder Spears", Type = "Style", Mult = 4.5, Effect = "Stun", Duration = 1, GasCost = 45, Cooldown = 8, Order = 11, ComboReq = "Reckless Barrage", ComboMult = 1.8, SFX = "BigExplosion", VFX = "ExplosionMark", Description = "A suicidal dive-bomb explosion for massive chain damage." },

	-- [[ ANTI-PERSONNEL ODM CHAIN ]]
	["Buckshot Spread"] = { Requirement = "Anti-Personnel", Type = "Style", Mult = 0.8, Hits = 3, GasCost = 10, Cooldown = 0, Order = 8, SFX = "Gun", VFX = "ExplosionMark", Description = "Fires a wide spread of buckshot from your ODM guns." },
	["Grapple Shot"] = { Requirement = "Anti-Personnel", Type = "Style", Mult = 1.4, Effect = "Stun", Duration = 1, GasCost = 15, Cooldown = 3, Order = 9, ComboReq = "Buckshot Spread", ComboMult = 1.4, SFX = "Grapple", VFX = "SlashMark", Description = "Fires a grappling hook into the target, staggering them." },
	["Executioner's Shot"] = { Requirement = "Anti-Personnel", Type = "Style", Mult = 3.5, Effect = "Bleed", Duration = 2, GasCost = 30, Cooldown = 5, Order = 10, ComboReq = "Grapple Shot", ComboMult = 1.6, SFX = "Sniper", VFX = "ExplosionMark", Description = "A point-blank, lethal shot to a grappled target." },
	["Knee Capper"] = { Requirement = "Anti-Personnel", Type = "Style", Mult = 1.5, Effect = "Crippled", Duration = 3, GasCost = 10, Cooldown = 4, Order = 11, SFX = "Gun", VFX = "SlashMark", Description = "Shoots the target's leg to cripple their speed." },
	...
	["God Speed"] = { Requirement = "Awakened Ackerman", Type = "Style", Mult = 1.5, Hits = 8, GasCost = 60, Effect = "Stun", Duration = 2, Cooldown = 6, Order = 17, ComboReq = "Swift Execution", ComboMult = 1.8, SFX = "SpinSlash", VFX = "ClawMark", Description = "Move faster than the eye can see, shredding the target completely." },
	...
	["Steam Bite"] = { Requirement = "Colossal Jaw Titan", Type = "Titan", Mult = 4.5, Effect = "Burn", Duration = 3, EnergyCost = 45, Cooldown = 4, Order = 11, SFX = "Bite", VFX = "ExplosionMark", Description = "A scorching, hyper-fast bite that melts armor." },	
