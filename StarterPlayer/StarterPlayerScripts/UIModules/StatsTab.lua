...
function StatsTab.Init(parentFrame, tooltipMgr)
	...
	local soldierColumn = SetupPanel("SOLDIER VITALITY", playerStatsList, false, ColumnsContainer)
	local titanColumn = SetupPanel("TITAN POTENTIAL", titanStatsList, true, ColumnsContainer)

	-- [[ THE FIX: Two Separate Training Boxes ]]
