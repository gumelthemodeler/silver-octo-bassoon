...
function RegimentTab.Init(parentFrame, tooltipMgr)
	...
	Title.Size = UDim2.new(1, 0, 0, 40); Title.BackgroundTransparency = 1; Title.Font = Enum.Font.GothamBlack; Title.TextColor3 = Color3.fromRGB(255, 255, 255); Title.TextSize = 24; Title.Text = "REGIMENT WARS"
	...
	LockedPanel.Size = UDim2.new(0.8, 0, 0, 200); LockedPanel.BackgroundColor3 = Color3.fromRGB(20, 20, 25); LockedPanel.LayoutOrder = 2
	...
	local lockTxt = Instance.new("TextLabel", LockedPanel); lockTxt.Size = UDim2.new(0.9, 0, 1, 0); lockTxt.Position = UDim2.new(0.05, 0, 0, 0); lockTxt.BackgroundTransparency = 1; lockTxt.Font = Enum.Font.GothamMedium; lockTxt.TextColor3 = Color3.fromRGB(200, 200, 200); lockTxt.TextSize = 16; lockTxt.TextWrapped = true; lockTxt.Text = "Complete '104th Cadet Corps Training' (Campaign Part 2) to pledge to a Regiment."

	ContentPanel = Instance.new("Frame", MainFrame)
	ContentPanel.Size = UDim2.new(0.8, 0, 0, 0); ContentPanel.AutomaticSize = Enum.AutomaticSize.Y; ContentPanel.BackgroundTransparency = 1; ContentPanel.LayoutOrder = 3
	...
	DominantLabel.Size = UDim2.new(1, 0, 0, 40); DominantLabel.BackgroundColor3 = Color3.fromRGB(25, 25, 30); DominantLabel.Font = Enum.Font.GothamBlack; DominantLabel.TextColor3 = Color3.fromRGB(255, 255, 255); DominantLabel.TextSize = 18; DominantLabel.Text = "AWAITING INTEL..."; DominantLabel.LayoutOrder = 1
	...
	local function CreateRegimentCard(name, color, imageId, subtext)
		...
		card.Size = UDim2.new(1, 0, 0, 110); card.BackgroundColor3 = Color3.fromRGB(22, 22, 28)
		...
		logo.Size = UDim2.new(0, 90, 0, 90); logo.Position = UDim2.new(0, 15, 0.5, 0); logo.AnchorPoint = Vector2.new(0, 0.5); logo.BackgroundTransparency = 1; logo.Image = imageId; logo.ScaleType = Enum.ScaleType.Fit; logo.ImageTransparency = 0.8; logo.ImageColor3 = color

		local title = Instance.new("TextLabel", card)
		title.Size = UDim2.new(0.5, 0, 0, 25); title.Position = UDim2.new(0, 120, 0, 10); title.BackgroundTransparency = 1; title.Font = Enum.Font.GothamBlack; title.TextColor3 = color; title.TextSize = 20; title.TextXAlignment = Enum.TextXAlignment.Left; title.Text = string.upper(name); title.ZIndex = 3

		local vpLbl = Instance.new("TextLabel", card)
		vpLbl.Size = UDim2.new(0.5, 0, 0, 30); vpLbl.Position = UDim2.new(0, 120, 0, 35); vpLbl.BackgroundTransparency = 1; vpLbl.Font = Enum.Font.GothamBlack; vpLbl.TextColor3 = Color3.fromRGB(255, 255, 255); vpLbl.TextSize = 18; vpLbl.TextXAlignment = Enum.TextXAlignment.Left; vpLbl.Text = "0 VP"; vpLbl.ZIndex = 3

		local barBg = Instance.new("Frame", card)
		barBg.Size = UDim2.new(0.55, 0, 0, 12); barBg.Position = UDim2.new(0, 120, 1, -25); barBg.BackgroundColor3 = Color3.fromRGB(15, 15, 20); Instance.new("UICorner", barBg).CornerRadius = UDim.new(0, 6); barBg.ZIndex = 2
		...
		joinBtn.Size = UDim2.new(0, 140, 0, 45); joinBtn.Position = UDim2.new(1, -20, 0.5, 0); joinBtn.AnchorPoint = Vector2.new(1, 0.5); joinBtn.Font = Enum.Font.GothamBlack; joinBtn.TextSize = 14; joinBtn.Text = "JOIN"; joinBtn.ZIndex = 4
